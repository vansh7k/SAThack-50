            ...
            {password && (
              <div className="mt-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                ...
                <div className="space-y-1 text-xs">
                  <div className={`flex items-center ${validation.isValidLength ? 'text-green-600' : 'text-red-600'}`}>
                    <span className="mr-2">{validation.isValidLength ? '✓' : '✗'}</span>
                    8-16 characters ({password.length})
                  </div>
